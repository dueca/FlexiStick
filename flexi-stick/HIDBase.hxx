...
struct HIDBase
{
  ...
  template <typename D> struct HIDInputValue : public FlexiLink
  {
    /** latest value */
    D value;
    /** Sticky, i.e. no spring release */
    bool sticky;
    ...
    /** Have state */
    bool haveState() const final { return sticky; }

    /** Code state into json */
    void takeSnapshot(dueca::smartstring::json_string_writer& writer) final;

    /** Load state from json */
    void loadSnapshot(const JValue& doc) final;
